...
int main()
{
	...
	//Pick Mode Type	
	printf("For Curent_Mirror_Load_OTA: Mode == 0");
	printf("\nFor Folded_Cascode_OTA: Mode == 1");
	int Mode;   
    printf("\n\nPlease Pick a Mode: ");
...
// Calculate Specs For each OTA
    ...
    // a9_OTA_Power_Consumption
    //OTA_Power_Consumption
